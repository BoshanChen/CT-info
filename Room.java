/**
 * This class represents a room in a residence hall of the UW-Madison University Housing. For now,
 * each room is assumed to have only one resident for isolation and social distancing purpose, but
 * this may be edited for future usage. This class provides basic information of the room and the
 * resident if it is not empty.
 * 
 * @author Haining Qiu
 *
 */
